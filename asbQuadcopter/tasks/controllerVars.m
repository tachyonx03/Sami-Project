...
% ADRC parameters for roll, pitch, yaw channels
Controller.ADRC.Ts = 0.005;
Controller.ADRC.wo = [60; 60; 50];
Controller.ADRC.wc = [20; 20; 15];
Controller.ADRC.b0 = [1/Vehicle.Airframe.inertia(1,1); ...
                      1/Vehicle.Airframe.inertia(2,2); ...
                      1/Vehicle.Airframe.inertia(3,3)];
Controller.ADRC.alpha = 0.5;
Controller.ADRC.delta = 0.01;
Controller.ADRC.refWeight = 1.0;
Controller.ADRC.uMin = -0.02 * ones(3,1);
Controller.ADRC.uMax = 0.02 * ones(3,1);
